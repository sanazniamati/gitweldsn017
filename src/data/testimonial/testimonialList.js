...
export default [
  {
    description:
      "Falcon is the best option if you are looking for a components built with Bootstrap. On top of that, Falcon's creators and support staff are very brilliant and attentive to users' needs.",
